...
class DiscTestToken extends Model
{
    protected $fillable = [
        'user_id',
        'candidate_id',
    ...
    public function discTestResult(): BelongsTo
    {
        return $this->belongsTo(DiscTestResult::class);
    }
     ...
     */
    public function markAsUsed(int $discTestResultId = null): void
    {
        $this->update([
            'status' => 'used',
            'used_at' => now(),
            'disc_test_result_id' => $discTestResultId,
        ]);
    }
