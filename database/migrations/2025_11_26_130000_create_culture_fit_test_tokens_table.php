...
return new class extends Migration
{
    ...
    {
        Schema::create('culture_fit_test_tokens', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('culture_fit_result_id')->nullable()->constrained()->onDelete('set null')->comment('Resultado do teste quando usado');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('culture_fit_test_tokens');
    }
};
